...
public class HttpGetStep extends HttpStep {
    ...
    public ResponseEntity<Object> getRequestResponse(DslInstance di) {
        ...
        return di.getHttpHelper().doMethod(HttpMethod.GET, evaluatedURL, evaluatedQuery, null, mappedHeaders, args.getContentType() , null, getLimit(), di, args.isDynamicParameters(), getTimeout());
    }
